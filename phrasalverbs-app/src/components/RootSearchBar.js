...
function RootSearchBar({ searchTerm, onSearch, onLetterFilter, currentLetter }) {
  const alphabet = 'abcdefghijklmnopqrstuvwxyz'.split('');

  return (
    <div className="bg-white rounded-xl shadow-lg p-5 mb-6 border border-gray-100">
      <div className="mb-5">
        <label htmlFor="rootSearch" className="block text-sm font-medium text-gray-700 mb-2">
          Search English Roots
        </label>
